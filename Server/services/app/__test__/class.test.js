...
describe("POST /classes", () => {
    ...
    request(app)
      ...
      .then((response) => {
        ...
        expect(body).toHaveProperty(
          "message",
          "Berhasil membuat kelas kelas tes"
        );
        done();
      })
      .catch((err) => {
  ...
  test("403 failed POST class forbidden", (done) => {
    request(app)
      .post("/classes")
      .set("access_token", validTokenStudent)
      .send({
...
describe("DELETE /classes/:ClassId", () => {
  ...
  test("403 failed DELETE class, role is not teacher", (done) => {
    request(app)
      .delete(`/classes/1`)
      .set("access_token", validTokenStudent)
      .then((response) => {
  ...
  test("404 failed DELETE class, class not found", (done) => {
    request(app)
      .delete(`/classes/99`)
      .set("access_token", validTokenTeacher)
      .then((response) => {
...
describe("GET /classes/myClasses", () => {
  test("200 success GET my class", (done) => {
    request(app)
  ...
  test("403 failed GET  myclasses forbidden", (done) => {
    request(app)
      .get("/classes/myClasses")
      .set("access_token", validTokenStudent)
      .then((response) => {
